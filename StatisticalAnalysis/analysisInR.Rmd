...
However, we cannot ensure with the same certainty, due to medium (r <= 0.5 and r > 0.1) or small effect size (r <= 0.1), that: 
...
All items: DMAOG/LDkit, Walder, RDF4J-Beans, LDflex
Search by fields: Walder, DMAOG, LDkit, LDflex and RDF4J-Beans
