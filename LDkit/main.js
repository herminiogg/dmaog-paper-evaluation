...
function showFilm(film) {
    console.log("".concat(film.$id, ", ").concat(film.name, ", ").concat(film.year, ", ").concat(film.countryOfOrigin, ", \n        ").concat(film.director, ", ").concat(film.musicBy, ", ").concat(film.screenwritter));
}
